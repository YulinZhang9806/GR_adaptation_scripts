...
out3=np.array(out3)
np.savetxt('AdaptiveMutation_MI0.01hard_additive_admix.txt',out3,fmt='%s',delimiter='\n',newline='\n')
...
out2=np.array(out2)
np.savetxt('AdaptiveMutation_MI0.001hard_additive_admix.txt',out2,fmt='%s',delimiter='\n',newline='\n')
...
out1=np.array(out1)
np.savetxt('AdaptiveMutation_MI0.0001hard_additive_admix.txt',out1,fmt='%s',delimiter='\n',newline='\n')
