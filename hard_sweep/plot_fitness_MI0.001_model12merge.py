########################################################
###for Figure 2 A-C, just change "additive" to "partial"/"recessive"
...
'''
l1,=plt.plot(times,data3,simID[run],linestyle='-.',label="model 2")
#l2,=plt.plot(times,data2,simID[run],linestyle='-.',label="0.001")
l3,=plt.plot(times,data1,simID[run],linestyle='-',label="model 1")
legend1=plt.legend(handles=[l3,l1],title='Demographic Models',loc='lower right',bbox_to_anchor=(1.34,0.7),edgecolor='black')
'''
...
plt.savefig('fitness_MIhard_additive_merge.svg',format='svg',bbox_inches = 'tight')
plt.close()
