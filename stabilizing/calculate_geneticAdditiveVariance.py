########################################################
###calculate genetic additive variance (GAV) based on AF & effect size
###for Figure 6 & S8
...
infile=open('admix_sqrt3000_model2_partial10_opt5_run4.out')
...
###record m2 messages in two populations before admixture
ind=0
...
###calculate GAV of each generation
l=1
...
for i in new:
	output+=str(i)+','
output+='\n'
outfile1=open('admix_sqrt3000_model2_partial10_opt5_run4.txt','w')
