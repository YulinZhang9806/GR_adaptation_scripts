########################################################
###for Figure S9 D-F, just change "additive" to "partial"/"recessive"
###change model2/60020 to model1/60000 to reproduce Figure S9 A-C
...
gen=[2,4,8,16,32,64,128,256,512,1000,1500,2000]
out1=[]
out2=[]
out3=[]
...
#plt.legend(title='Admixture fraction',loc='lower right',bbox_to_anchor=(1.31,0),edgecolor='black')
plt.savefig('ancestryGenome_stabilizing_model2_sqrt3000_additive_opt1_admix.svg',format='svg',bbox_inches = 'tight')
plt.close()
