...
out3=np.array(out3)
np.savetxt('AdaptiveMutation_MI0.01soft_recessive_admix.txt',out3,fmt='%s',delimiter='\n',newline='\n')
...
out2=np.array(out2)
np.savetxt('AdaptiveMutation_MI0.001soft_recessive_admix.txt',out2,fmt='%s',delimiter='\n',newline='\n')
