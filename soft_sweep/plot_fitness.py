...
out1=np.array(out1)
np.savetxt('fitness_MI0.01soft_recessive_admix.txt',out1,fmt='%s',delimiter='\n',newline='\n')
...
out2=np.array(out2)
np.savetxt('fitness_MI0.001soft_recessive_admix.txt',out2,fmt='%s',delimiter='\n',newline='\n')
...
plt.savefig('fitness_MIsoft_recessive_admix_2.svg',format='svg',bbox_inches = 'tight')
plt.close()
